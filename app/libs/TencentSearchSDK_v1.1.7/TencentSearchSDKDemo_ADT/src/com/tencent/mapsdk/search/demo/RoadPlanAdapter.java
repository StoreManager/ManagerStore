...
//		tricycleRoutes = null;
		...
		} /*else if (obj instanceof TricycleResultObject) {
			TricycleResultObject tricycleObj = (TricycleResultObject) obj;
			tricycleRoutes = tricycleObj.result.routes;
		}*/
	}
...
//		}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = 
					View.inflate(mContext, R.layout.suggestion_list_item, null);
