...
public class SearchBasicActivity extends Activity {
	...
	private static class MyHandler extends Handler {
		private WeakReference<SearchBasicActivity> mActivity;
		public MyHandler(SearchBasicActivity activity) {
			// TODO Auto-generated constructor stub
			mActivity = new WeakReference<SearchBasicActivity>(activity);
		}
	...
	protected void streetViewData() {
		...
		tencentSearch.getpano(streetViewParam, new HttpResponseListener() {
			...
			public void onSuccess(int arg0, BaseObject arg1) {
				...
				StreetViewResultObject obj = (StreetViewResultObject)arg1;
				StringBuilder sb = new StringBuilder();
