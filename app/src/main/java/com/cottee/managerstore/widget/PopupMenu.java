...
public class PopupMenu extends PopupWindow implements OnClickListener {
	...
	public PopupMenu(Activity activity , String[] tabs) {
		...
		tvAboutUs.setText(tabs[0]);

		TextView tvtwo = (TextView)v_item2.findViewById(R.id.tv_check_update);
		tvtwo.setText(tabs[1]);


		TextView tvThree = (TextView)v_item3.findViewById(R.id.tv_feedback);
		tvThree.setText(tabs[2]);
