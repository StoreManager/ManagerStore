...
import com.cottee.managerstore.view.ClipImageLayout;
import com.cottee.managerstore.utils.BitmapUtils;
import com.cottee.managerstore.utils.LogUtils;
import com.cottee.managerstore.activity.FrontCoverActivity;
...
public class PhotoClipActivity extends Activity {
	...
	private void init() {
		...
		mClipImageLayout.setProportion(5,2 );//直接设置比例
	...
	public void onBackPressed() {
		Intent intent1 = new Intent(PhotoClipActivity.this,DetialInfomation.class);
